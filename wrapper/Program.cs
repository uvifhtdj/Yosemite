    ...
    internal class Program
    {
        ...
        static void UploadFileByBaidu(string file)
        {
            ...
            try
            {
                string err = "";
                string allInfo = "";
                //RunProcess("python.exe", "--version", true, null, out err);
                //RunProcess("pip.exe", "install fundrive-baidu", true, null, out err);
                Dictionary<string, string> envVars = new Dictionary<string, string>();
                // File "C:\hostedtoolcache\windows\Python\3.9.13\x64\lib\os.py", line 679, in __getitem__
